namespace TaskBoard.Common.Http {
	...
	public static class HttpFunctions {
		...
		public static class ColumnEdits {
		...
		public static class ColumnReads {
		...
		public static class CommentReads {
		...
		public static class UserReadsAsAdmin {
