...
namespace TaskBoard.Server.Functions.Protected.WithReturn.Database.TaskReads {
	...
	public class GetTaskIdsFromColumnFunction : HttpProtectedFunctionWithReturn<TaskId[]> {
		public override string NameOfCalledMethod => HttpFunctions.TaskReads.GetTaskIdsFromColumn;
