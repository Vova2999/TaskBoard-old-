...
namespace TaskBoard.Server.Handlers.WithReturn.Database.ColumnReads {
	...
	public class GetAllColumnsHandler : HttpHandlerBaseWithReturn<Column[]> {
		public override string HandlerName => HttpHandlerNames.Column.Reads.GetAllColumns;
		protected override AccessType? RequiredAccessType => AccessType.UserRead;
		private readonly IDatabaseColumnReader databaseColumnReader;

		public GetAllColumnsHandler(IDatabaseAuthorizer databaseAuthorizer, IDatabaseColumnReader databaseColumnReader) : base(databaseAuthorizer) {
