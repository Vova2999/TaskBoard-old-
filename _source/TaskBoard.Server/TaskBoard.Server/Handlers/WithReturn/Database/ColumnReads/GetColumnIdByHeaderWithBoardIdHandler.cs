...
namespace TaskBoard.Server.Handlers.WithReturn.Database.ColumnReads {
	...
	public class GetColumnIdByHeaderWithBoardIdHandler : HttpHandlerBaseWithReturn<ColumnId> {
		public override string HandlerName => HttpHandlerNames.Column.Reads.GetColumnIdByHeaderWithBoardId;
		protected override AccessType? RequiredAccessType => AccessType.UserRead;
		private readonly IDatabaseColumnReader databaseColumnReader;

		public GetColumnIdByHeaderWithBoardIdHandler(IDatabaseAuthorizer databaseAuthorizer, IDatabaseColumnReader databaseColumnReader) : base(databaseAuthorizer) {
