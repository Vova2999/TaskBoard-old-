...
namespace TaskBoard.Server.Handlers.WithReturn.Database.CommentReads {
	...
	public class GetAllCommentsHandler : HttpHandlerBaseWithReturn<Comment[]> {
		public override string HandlerName => HttpHandlerNames.Comment.Reads.GetAllComments;
		protected override AccessType? RequiredAccessType => AccessType.UserRead;
		private readonly IDatabaseCommentReader databaseCommentReader;

		public GetAllCommentsHandler(IDatabaseAuthorizer databaseAuthorizer, IDatabaseCommentReader databaseCommentReader) : base(databaseAuthorizer) {
