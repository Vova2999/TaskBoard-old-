...
namespace TaskBoard.Server.Handlers.WithReturn.Database.BoardReads {
	...
	public class GetBoardIdByNameHandler : HttpHandlerBaseWithReturn<BoardId> {
		public override string HandlerName => HttpHandlerNames.Board.Reads.GetBoardIdByName;
		protected override AccessType? RequiredAccessType => AccessType.UserRead;
		private readonly IDatabaseBoardReader databaseBoardReader;

		public GetBoardIdByNameHandler(IDatabaseAuthorizer databaseAuthorizer, IDatabaseBoardReader databaseBoardReader) : base(databaseAuthorizer) {
