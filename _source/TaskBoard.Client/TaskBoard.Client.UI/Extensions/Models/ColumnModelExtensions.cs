...
namespace TaskBoard.Client.UI.Extensions.Models {
	public static class ColumnModelExtensions {
		public static ColumnModel DownloadTaskModels(this ColumnModel columnModel, IHttpClientProvider httpClientProvider) {
			columnModel.TaskModels = new ObservableCollection<TaskModel>(httpClientProvider.GetDatabaseTaskReader().GetFromColumn(columnModel.BoardModel.BoardId, columnModel.ColumnId).ToModels(httpClientProvider));
			return columnModel;
		}
	}
}